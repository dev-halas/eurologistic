<section class="contact animate">
    <div class="contactInner">
        ...
        <div class="contactRight">
            ...
            <h1 class="contactRight--title">kontaktować się</h1>
            <div class="contactRight--text">
                z pracownikami naszego biura w Poznaniu, skąd
                z pewnością otrzymacie Państwo szybką
                i kompetentną odpowiedź.
            </div>
